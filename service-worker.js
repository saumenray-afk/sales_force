// ===== SERVICE WORKER - SALES FORCE DEMO =====

const CACHE_NAME = 'sales-force-demo-v1.0.0';
const RUNTIME_CACHE = 'sales-force-runtime-v1.0.0';

// Assets to cache on install
const PRECACHE_ASSETS = [
    '/sales_force/',
    '/sales_force/index.html',
    '/sales_force/styles.css',
    '/sales_force/app.js',
    '/sales_force/config.js',
    '/sales_force/pwa.js',
    '/sales_force/manifest.json',
